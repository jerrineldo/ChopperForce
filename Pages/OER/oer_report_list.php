...
<div class="m-1">
    ...
    <table class="table table-bordered tbl">
        ...
        <tr>
            ...
            <th><?= $oer->id; ?></th>
            <th><?= $oer->rank; ?></th>
            <th><?= $oer->first_name; ?></th><!--generated by USER table.FirstName-->
            <th><?= $oer->last_name; ?></th><!--generated by USER table.LastName-->
            <th><?= $oer->rater; ?></th>
            <th><?= $oer->int_rater; ?></th>
            ...
            <th><?= $oer->remarks; ?></th>
                ...
                <td>
                    <form action="../Pages/OER/deleteOER.php" method="post">
                        <input type="hidden" name="id" value="<?= $oer->id; ?>"/>
